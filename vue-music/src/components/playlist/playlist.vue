  ...
  <transition name="list-fade">
    <div class="playlist" v-show="showFlag" @click="hide">
      <div class="list-wrapper" @click.stop>
        ...
        <scroll class="list-content" :data="sequenceList" ref="scroll" :refreshDelay="refreshDelay">
          <transition-group name="list" ref="list" tag="ul">
            <li :key="item.id" class="item" ref="songItem" v-for="(item, index) in sequenceList"
  ...
  export default {
    ...
    methods: {
      ...
      scrollToCurrent(current) {
        ...
        this.$refs.scroll.scrollToElement(this.$refs.songItem[index], 300)
      },
      deleteItem(item) {
